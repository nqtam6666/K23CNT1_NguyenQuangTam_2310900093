                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-5 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                  <input type="text" id="nqtMaLoai" class="form-control" name="nqtMaLoai" value="{{old('nqtMaLoai')}}">
                                </div>
                                @error('nqtMaLoai')
                            ...
                            <div class="row g-5 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                  <input type="text" id="nqtTenLoai" class="form-control" name='nqtTenLoai' value="{{old('nqtTenLoai')}}">
                                </div>
                                @error('nqtTenLoai')
                                        <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
